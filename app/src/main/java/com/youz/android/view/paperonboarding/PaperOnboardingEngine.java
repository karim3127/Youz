package com.youz.android.view.paperonboarding;
...
import com.youz.android.view.paperonboarding.listeners.OnSwipeListener;
import com.youz.android.view.paperonboarding.listeners.PaperOnboardingOnChangeListener;
import com.youz.android.view.paperonboarding.listeners.PaperOnboardingOnLeftOutListener;
import com.youz.android.view.paperonboarding.listeners.PaperOnboardingOnRightOutListener;
import com.youz.android.view.paperonboarding.utils.PaperOnboardingEngineDefaults;
...
public class PaperOnboardingEngine implements PaperOnboardingEngineDefaults {
    ...
    private final Typeface typeface, typefaceBold;
    ...
    public PaperOnboardingEngine(View rootLayout, ArrayList<PaperOnboardingPage> contentElements, Context appContext) {
        ...
        typeface = Typeface.createFromAsset(appContext.getAssets(), "fonts/Optima-Regular.ttf");
        typefaceBold = Typeface.createFromAsset(appContext.getAssets(), "fonts/ElMessiri-Medium.ttf");
    ...
    protected ImageView createContentIconView(PaperOnboardingPage PaperOnboardingPage) {
        ...
        int px = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 150, mAppContext.getResources().getDisplayMetrics());
        FrameLayout.LayoutParams iconLP = new FrameLayout.LayoutParams(px, px);
