...
import com.youz.android.activity.SignUp;
...
public class CodeCountryPopUpItemAdapter extends RecyclerView.Adapter<CodeCountryPopUpItemAdapter.MyViewHolder> {
    ...
    public CodeCountryPopUpItemAdapter(Context context, AlertDialog alert, List<Country> mCountriesList, TextView code){
        c = context;
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            SignUp.codeCountryTel = country.getCountryCode() + "";
            SignUp.country = country.getName();
