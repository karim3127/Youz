...
public class HomeRecentPopularFragment extends Fragment {
    ...
    public HomeRecentPopularFragment() {
        // Required empty public constructor
    }

    public static HomeRecentPopularFragment newInstance() {
        HomeRecentPopularFragment fragment = new HomeRecentPopularFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        layout = inflater.inflate(R.layout.fragment_home_recent_popular, container, false);
        return layout;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ((MainActivity) getActivity()).homeRecentPopularFragment = this;

        prefs = getContext().getSharedPreferences("com.youz.android", Context.MODE_PRIVATE);
        userId = prefs.getString("UserId", "");

        mPostPopularQuery = mPostPopularRef.orderByChild("note");
        ...
        gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                if (listPosts.get(position) == null) {
        ...
        childEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                if (dataSnapshot.getValue() != null) {
                    ...
                    long isNote = (postDetails.get("note") != null) ? (long) postDetails.get("note") : 0;
                    ...
                    if (isPublic && !isBlocked && isNote > 0) {
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                ...
                if (isHere) {
                    ...
                    if (!isBlocked && isPublic && isNote > 0) {
                        Pair<String, HashMap<String, Object>> item = new Pair<>(dataSnapshot.getKey(), (HashMap<String, Object>) dataSnapshot.getValue());
