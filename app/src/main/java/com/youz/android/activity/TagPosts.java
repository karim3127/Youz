...
public class TagPosts extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listPostIds = getIntent().getExtras().getStringArrayList("PostIds");
    ...
    public void getListTags() {
        ...
        for (int i = 0; i < listPostIds.size(); i++) {

            mPostQuery = mPostRef.child(listPostIds.get(i));
